---
name: vault:snapshot
description: Create, list, inspect, or delete vault snapshots. Point-in-time recovery for .dev-vault/ files (excludes .edit-log.json, .profile-state, *.engram-trace.jsonl, snapshots/). Delete always shows manifest + requires explicit yes/no even with --force.
allowed-tools: [Bash]
invocation: user
---
