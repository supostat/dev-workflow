---
name: vault:arch
description: Read-only architecture analysis. Researches codebase and vault, proposes 2-3 solutions with trade-offs, recommends one. Does NOT write code. Use when designing a new component, choosing between approaches, or evaluating refactor scope.
allowed-tools: [Read, Grep, Bash, mcp__dev-workflow__vault_read, mcp__dev-workflow__memory_search, mcp__dev-workflow__memory_judge, mcp__dev-workflow__vault_record]
invocation: user
---
