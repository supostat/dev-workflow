---
name: task
description: Create, track, and manage development tasks linked to git branches and workflows. Wraps dev-workflow task CLI subcommands for create/list/start/update lifecycle operations.
allowed-tools: [Bash, mcp__dev-workflow__task_create, mcp__dev-workflow__task_list, mcp__dev-workflow__task_start, mcp__dev-workflow__task_update]
invocation: user
---
