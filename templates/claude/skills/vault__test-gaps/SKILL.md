---
name: vault:test-gaps
description: Inventory untested and under-tested source files; classify by criticality (untested vs missing-edge-cases) with quality observations. Read-only — never creates test files. Optionally records gaps as /vault:debt entries for tracking.
