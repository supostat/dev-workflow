---
name: vault:search
description: Search the vault by text query across stack, conventions, knowledge, gameplan, daily logs, debt, bugs, and ADRs. Delegates to dev-workflow search CLI.
allowed-tools: [Bash, mcp__dev-workflow__vault_search]
invocation: user
---
