---
name: vault:analyze
description: Scan an existing codebase (5-15 sample files) and fill conventions.md + knowledge.md with discovered patterns through phased gates. Use when initializing the vault on a project that has code but no SPEC — complements /vault:from-spec for the codebase-first path.
