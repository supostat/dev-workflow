---
name: intake
description: Read-only intake step for free-form requests, ideas, files, or copy/paste content. Classifies the request, proposes 2-3 concrete workflow options with trade-offs, and recommends one. Does NOT write code or run any other workflow — the user picks and runs the recommended workflow next.
allowed-tools: [Read, Bash, mcp__dev-workflow__memory_search, mcp__dev-workflow__memory_judge]
invocation: user
---
