---
name: vault:adr
description: Record an architecture decision to .dev-vault/architecture/ with context, alternatives, and consequences. Engram-aware — searches prior memories before drafting, judges them inline, and stores the resulting decision for future cross-run recall. Use when choosing between frameworks, defining contracts, or changing project structure.
allowed-tools: [Edit, mcp__dev-workflow__memory_search, mcp__dev-workflow__memory_judge, mcp__dev-workflow__memory_store, mcp__dev-workflow__vault_record]
invocation: user
---
