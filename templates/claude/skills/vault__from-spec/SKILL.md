---
name: vault:from-spec
description: Fill .dev-vault/ sections (stack.md, conventions.md, knowledge.md, gameplan.md) from a SPEC.md file in 4 phased gates with user approval. Use when starting a new project from a spec or refreshing the vault after spec edits. Records SPEC hash for drift detection.
allowed-tools: [Read, Edit, Bash, mcp__dev-workflow__vault_record, mcp__dev-workflow__task_create]
invocation: user
---
