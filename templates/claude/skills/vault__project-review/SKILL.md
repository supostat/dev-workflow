---
name: vault:project-review
description: Full project audit covering security, code quality, test coverage, debt accumulation, and architectural drift. Emits structured findings to vault. Use periodically (monthly/release) or before major refactors.
allowed-tools: [Read, Grep, Bash, mcp__dev-workflow__memory_search, mcp__dev-workflow__memory_judge, mcp__dev-workflow__vault_record, mcp__dev-workflow__vault_knowledge]
invocation: user
---
