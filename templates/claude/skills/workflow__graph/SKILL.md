---
name: workflow:graph
description: Render a workflow as a Mermaid flowchart (default) or ASCII diagram. Use to inspect step dependencies, gates, onFail edges, and runtime Next-directive whitelisting. Read-only — delegates to dev-workflow workflow graph CLI.
allowed-tools: [Bash]
invocation: user
---
