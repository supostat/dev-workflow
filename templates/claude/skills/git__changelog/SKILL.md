---
name: git:changelog
description: Generate a Keep-a-Changelog-style changelog from git history. Categorises commits by prefix (Added/Changed/Fixed/Removed/Security), groups related entries, skips merges. Optionally prepends to CHANGELOG.md.
