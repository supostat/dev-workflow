---
name: vault:pattern
description: Append a reusable code or process pattern bullet to conventions.md (default Patterns section). Use when a recurring solution emerges across 2+ places and should be canonicalized for future reviews.
allowed-tools: [mcp__dev-workflow__vault_pattern, mcp__dev-workflow__memory_search, mcp__dev-workflow__memory_judge]
invocation: user
---
