---
name: session:resume
description: Restore session context — load all 4 vault files (stack/conventions/knowledge/gameplan), branch context, 3 most recent daily logs, active tasks, and paused workflows. Read-only — never modifies vault. Use at the start of a fresh Claude Code session to rebuild project state.
