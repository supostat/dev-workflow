---
name: session:review
description: Multi-perspective code review of uncommitted changes (Security, Quality, Conventions, Completeness, Pragmatism) with conflict detection between perspectives. Read-only — never modifies project code. Use before commit to surface findings on the current working tree.
