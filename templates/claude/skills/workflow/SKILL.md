---
name: workflow
description: Top-level workflow management slash. Run, resume, or check status of development workflows. Delegates to dev-workflow CLI subcommands and orchestrator. For specific workflow types (dev, hotfix, review, etc.) use the namespaced /workflow:<name> skill instead.
allowed-tools: [Bash, Agent, mcp__dev-workflow__workflow_status]
invocation: user
---
