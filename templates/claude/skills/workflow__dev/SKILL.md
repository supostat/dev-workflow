---
name: workflow:dev
description: 11-step development pipeline (preflight, read, plan, plan-review, plan-fix, code, review, test, verify, commit, vault-updates) with engram-aware memory loop. Multi-agent orchestrator dispatching subagents with verdict-aware gates and structured findings recorded to vault.
allowed-tools: [Bash, Read, Edit, Grep, Agent, mcp__dev-workflow__workflow_start, mcp__dev-workflow__step_start, mcp__dev-workflow__step_complete, mcp__dev-workflow__memory_search, mcp__dev-workflow__memory_store, mcp__dev-workflow__memory_judge, mcp__dev-workflow__parse_engram_feedback, mcp__dev-workflow__vault_record, mcp__dev-workflow__vault_knowledge, mcp__dev-workflow__vault_pattern, mcp__dev-workflow__task_list, mcp__dev-workflow__task_update]
invocation: user
---
