---
name: git:merge
description: Transfer knowledge from a merged branch into permanent storage — decisions and gotchas into knowledge.md, unfinished items into gameplan.md backlog. Updates branch file status to merged. Append-only — never overwrites existing vault content.
