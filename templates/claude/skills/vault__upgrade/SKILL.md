---
name: vault:upgrade
description: Safely upgrade dev-workflow templates and config in this project against the installed package version. Two-phase plan/apply with ms-precision backup, classification by category (auto-overwrite-safe vs user-modified), and security-hardened path validation.
