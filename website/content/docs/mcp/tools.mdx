---
title: MCP Tools
description: 24 программных инструмента (vault, tasks, intelligence, memory, workflows, agents, communication profiles)
---

# MCP Tools

MCP-сервер dev-workflow предоставляет 24 tools. Конфигурируется в `.mcp.json` при `dev-workflow init`.
