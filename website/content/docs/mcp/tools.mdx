---
title: MCP Tools
description: 14 программных инструментов для работы с vault, задачами, intelligence
---

# MCP Tools

MCP-сервер dev-workflow предоставляет 14 tools. Конфигурируется в `.mcp.json` при `dev-workflow init`.
