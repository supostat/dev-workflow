---
title: MCP Tools
description: 25 программных инструмента (vault, tasks, intelligence, memory, workflows, agents, communication profiles)
---

# MCP Tools

MCP-сервер dev-workflow предоставляет 25 tools. Конфигурируется в `.mcp.json` при `dev-workflow init`.
